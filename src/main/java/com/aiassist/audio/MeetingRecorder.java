...
/**
 * Records the meeting audio while it is live: one raw 16&nbsp;kHz mono 16-bit
 * PCM file per source label ("you", "other"). Appends across pause/resume,
 * and on {@link #finish()} hands the files to the meeting-end flow, which
 * transcribes them in full for the saved notes. Kept in OS temp space and
